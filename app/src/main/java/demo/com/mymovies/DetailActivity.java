...
import demo.com.mymovies.utils.NetworkUtils;
 ...
 public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     public void onClickChangeFavourites(View view) {
     ...
     private void setFavourite() {
         favouriteMovie = viewModel.getFavoriteMovieById(id);
         if(favouriteMovie == null ) {
             imageViewAddToFavourite.setImageResource(R.drawable.favourite);
         } else {
             imageViewAddToFavourite.setImageResource(R.drawable.saved);
         }
     }
 }
